...
{
  act_map::QuadraticVisScore vscore(hfov_rad_);
...
TEST_F(VisScoreTest, testApproxInit)
{
  ...
  // with options
  {
    ...
    act_map::QuadraticVisScore vscore2(options);
  ...
  {
    act_map::QuadraticVisScore vscore3(M_PI / 2.5);
...
{
  act_map::QuadVisScorePtr vis_score_ptr = act_map::QuadraticVisScore::load(abs_cfg_fn_);
